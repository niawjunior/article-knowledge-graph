...
import { EntityDefinition, RelationshipDefinition, Ontology } from '@/lib/ontology-types';
...
export default function EditOntologyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'Failed to update ontology');
      }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 mt-1">
                Update your custom ontology definitions
              </p>
            </div>
          </div>
        </div>
